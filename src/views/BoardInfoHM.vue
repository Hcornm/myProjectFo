    ...
    <div class="board_wrap">
      ...
      <div class="board_reply_wrap">
        <div class="board_reply">
          <div v-for="(replyItem, replyIndex) in hmReply" :key="replyIndex">
            <div class="board_reply_info" v-if="replyItem.parentHmReply === null">
              <dl>
              ...
              <div v-if="replyItem.childrenHmReply.length !== 0">
                <div v-for="(rereplyItem, rereplyIndex) in replyItem.childrenHmReply" :key="rereplyIndex">
                  <dl>
                    <dt>{{ replyItem.childrenHmReply[replyIndex].writer }}</dt>
                    <dd><a>수정</a><a>삭제</a></dd>
                  </dl>
                  <dl>
                    <dt>{{ replyItem.childrenHmReply[replyIndex].content }}</dt>
                    <dd></dd>
                  </dl>
                  <dl>
                    <dt>{{ replyItem.childrenHmReply[replyIndex].writeDate }}</dt>
                    <dd><span>답글쓰기</span></dd>
                  </dl>
                </div>
              </div>
            </div>
            ...
            <div class="board_reply_info" v-if="replyItem.parentHmReply === null">
              ...
              <div v-if="replyItem.childrenHmReply.length !== 0">
                <div v-for="(rereplyItem, rereplyIndex) in replyItem.childrenHmReply" :key="rereplyIndex">
                  ...
                  <div v-for="(parentHmReply, parentHmReplyIndex) in replyItem.childrenHmReply[replyIndex].parentHmReply.childrenHmReply" :key="parentHmReplyIndex">
                    <dl>
                      <dt>{{ parentHmReply.content }}</dt>
                      <dd><a>수정</a><a>삭제</a></dd>
                    </dl>
                    <dl>
                      <dt>{{ parentHmReplyIndex }} index</dt>
                      <dd></dd>
                    </dl>
                    <dl>
                      <dt></dt>
          ...
          <div v-for="(replyItem, replyIndex) in hmReply" :key="replyIndex">
            <div class="board_reply_info" v-if="replyItem.parentHmReply === null">
              ...
              <div v-for="(rereplyItem, rereplyIndex) in replyItem.childrenHmReply" :key="rereplyIndex">
                ...
                <!-- <div v-for="(rerereplyItem, rerereplyIndex) in rereplyItem.parentHmReply.childrenHmReply" :key="rerereplyIndex">
                  <dl>
                    <dt>{{ rerereplyItem }}</dt>
                    <dd><a>수정</a><a>삭제</a></dd>
                  </dl>
...
export default {
  ...
  computed: {
    // computedStyleObject() {
    //   return {
    //     'depth': this.depth, // testColor 는 예시 변수명
    //     };
    // },
  },
