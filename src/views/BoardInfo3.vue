    ...
    <div class="board_wrap">
      ...
      <div class="board_reply_wrap">
        <div class="board_reply">
          <div v-for="(replyItem, replyIndex) in hmReply.hmReplyList" :key="replyIndex" class="board_reply_info">
            <!-- 루트 -->
            <div>
              <dl>
            ...
            <!-- 루트 -->
            <!-- 서브 -->
            <div v-show="replyItem.subMenu.length">
              <div v-for="(subItem, subIndex) in replyItem.subMenu" :key="subIndex" class="board_reply_info_re">
                <dl>
                ...
                <!-- 서브 안-->
                <div v-for="(subsItem, subsIndex) in subItem.subMenu" :key="subsIndex" class="board_reply_info_re2">
                  <dl>
                    <dt>{{ subsItem.writer }}</dt>
                    <dd><a>수정</a><a>삭제</a></dd>
                  </dl>
                  <dl>
                    <dt>{{ subsItem.content }}</dt>
                    <dd></dd>
                  </dl>
                  <dl>
                    <dt>{{ subsItem.writeDate }}</dt>
                    <dd>답글쓰기</dd>
                  </dl>
                </div>
                <!--서브 안 -->
